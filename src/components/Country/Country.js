        ...
        {loading ? (
          <section className="corona-stats">
            <h2 className="corona-title">
              {" "}
              Loading Covid-19 data from {country.name}...{" "}
            </h2>
          </section>
            ...
            <div className="info-wrapper">
              ...
              <span className="info-content">
                {`${formatNumberWithComma(countryCovid.confirmed.value)} | ` ||
                  "-"}
                <i>{`${parseFloat(
                  (countryCovid.confirmed.value * 100) / country.population
                ).toFixed(2)}% of ${country.name} population`}</i>
              </span>
            </div>
            <div className="info-wrapper">
              ...
              <span className="info-content">
                ...
                <i>
                  {`${Math.round(
                    (countryCovid.recovered.value * 100) /
                      countryCovid.confirmed.value
                  )}% recovery rate` || ""}
                </i>
              </span>
            </div>
          ...
          <section className="corona-stats">
            <h2 className="corona-title">
              {" "}
              Country not found in JHU database :({" "}
            </h2>
          </section>
        )}
      </div>
